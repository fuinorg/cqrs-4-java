 ...
 * {@link QuarkusProcessTimeoutSweeper} so that it no longer loops forever while remaining visible for manual
 * inspection and re-processing.
 */
@NotThreadSafe
@Entity
@Table(name = "QUARKUS_PM_TIMEOUT_DEAD_LETTER")
