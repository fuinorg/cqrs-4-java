...
public final class PersonId extends AggregateRootUuid {
     ...
     *            Value.
     */
    public PersonId(final UUID value) {
        super(TYPE, value);
    }
    ...
    @Documented
    public static @interface PersonIdStr {

        String message()

        default "{org.fuin.cqrs4j.test.model.PersonId.message}";
     ...
     */
    public static final class Validator implements ConstraintValidator<PersonIdStr, String> {

        @Override
        public final void initialize(final PersonIdStr annotation) {
            // Not used
        }

        @Override
        public final boolean isValid(final String value, final ConstraintValidatorContext context) {
            return PersonId.isValid(value);
        }
     ...
     */
    public static final class Converter implements JsonbAdapter<PersonId, UUID>, AttributeConverter<PersonId, UUID> {

        private PersonId toVO(final UUID value) {
            if (value == null) {
                return null;
            }
        ...
        private UUID fromVO(final PersonId value) {
            if (value == null) {
                return null;
            }
        ...
        @Override
        public final PersonId adaptFromJson(final UUID str) throws Exception {
            return toVO(str);
        }
        ...
        @Override
        public final UUID convertToDatabaseColumn(final PersonId value) {
            return fromVO(value);
        }

        @Override
        public final PersonId convertToEntityAttribute(final UUID value) {
            return toVO(value);
        }
    }
