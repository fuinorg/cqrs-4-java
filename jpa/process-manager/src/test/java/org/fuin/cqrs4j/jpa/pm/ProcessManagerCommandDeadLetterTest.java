...
class ProcessManagerCommandDeadLetterTest {
    ...
    void testConstructorAndGetters() {
        final ProcessManagerCommandDeadLetter dl = new ProcessManagerCommandDeadLetter("id-1", "MyCommand",
                "application/json;version=3", "{}", 1L, 9L, 5, "boom");
        assertThat(dl.getId()).isEqualTo("id-1");
        assertThat(dl.getType()).isEqualTo("MyCommand");
        assertThat(dl.getContentType()).isEqualTo("application/json;version=3");
    ...
    void testFromOutbox() {
        ...
        assertThat(dl.getId()).isEqualTo("id-1");
        assertThat(dl.getType()).isEqualTo("MyCommand");
        assertThat(dl.getContentType()).isEqualTo("application/json;version=2");
        assertThat(dl.getJson()).isEqualTo("{}");
        assertThat(dl.getCreatedTs()).isEqualTo(1L);
        assertThat(dl.getFailedTs()).isEqualTo(9L);
