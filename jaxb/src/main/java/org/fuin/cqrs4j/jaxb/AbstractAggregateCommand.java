 ...
 * @param <ENTITY_ID> Type of the identifier (the last one in the path).
 */
public abstract class AbstractAggregateCommand<ROOT_ID extends AggregateRootId, ENTITY_ID extends EntityId> extends AbstractCommand
     ...
     *
     * @param <ROOT_ID>   Type of the aggregate identifier.
     * @param <ENTITY_ID> Type of the entity identifier.
